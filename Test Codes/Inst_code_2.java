...
public final class Inst_code_2 {
  private final int degree;
  private final double coeff[];

  public Inst_code_2(double coeff[]) {
    this.coeff = coeff;
  ...
  public Inst_code_2 differentiate() {
    ...
    return new Inst_code_2(derivativeCoeff);
  }
  ...
  public static void main(String[] args) { 
	  ...
	  var originalPoly = new Inst_code_2(array);
